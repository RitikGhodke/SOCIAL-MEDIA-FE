...
//     async function getData() {
//       try {
//         const res = await axios.get( import.meta.env.VITE_DOMAIN +`/api/follow-requests`,
//           { withCredentials: true }
//         )
//         setRequests(res.data.data)
//       } catch (error) {
...
//     try {
//       await axios.post(import.meta.env.VITE_DOMAIN + `/api/follow-requests/review/${itemId}/${status}`,
//         {},
//         { withCredentials: true }
//       )
